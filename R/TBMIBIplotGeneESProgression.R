...
setwd("/Volumes/GoogleDrive/My Drive/Angelo Lab/MIBIProjects/Human_ATB_paper-cohort/TB_MIBI_Khatri/Erin_TB/effect sizes")
ES_data<-read.csv("ESprogression_profiles_allgenes.csv")
