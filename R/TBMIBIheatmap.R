...
##..Drop MAC..##
MAC_samples<-c(21,23)
data_gran<-data[!data$PatientID %in% MAC_samples,]
...
functional<-c("IDO","PD.L1","iNOS","CD36")

heatmap_channels<-unique(c(major,immune,myeloid,lymph))

row_order<-c("CD4_T","CD8_T","CD14_Mono","B_cell","CD11b/c_CD206_Mac/Mono","CD11c_DC/Mono","CD16_CD14_Mono","imm_other","endothelial","CD68_Mac",
         "CD206_Mac","fibroblast","epithelial","neutrophil","CD209_DC","CD163_Mac","mast","Treg","gdT_cell","giant_cell")
